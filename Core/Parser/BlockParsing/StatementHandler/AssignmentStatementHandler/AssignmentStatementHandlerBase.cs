...
{
  public abstract class AssignmentStatementHandlerBase: StatementHandlerBase<AssignmentStatement>
  {
    ...
    public bool Covers (Statement statement)
    {
      ...
      if (statement is AssignmentStatement)
      {
        ...
        covers = CoversAssignment (assignment);
      }
      return covers;
    }

    protected abstract bool CoversAssignment (AssignmentStatement assignmentStatement);
  }
}
