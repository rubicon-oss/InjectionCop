...
namespace InjectionCop.Parser
{
  public class SafenessManager
  {
    ...
    {
      bool literalOrFragment = expression is Literal || FragmentTools.Returns<SqlFragmentAttribute> (expression);
    ...
    public bool ParametersSafe (MethodCall methodCall)
    {
      ...
      {
        bool isFragmentParameter = FragmentTools.Contains<SqlFragmentAttribute> (calleeMethod.Parameters[i].Attributes);
