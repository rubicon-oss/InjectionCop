...
namespace InjectionCop.IntegrationTests.Parser.TypeParserTests.BlackMethod
{
  [TestFixture]
  public class BlackMethod_TypeParserTest: TypeParserTestBase
  {
    [Test]
    [Category("BlackMethod")]
    public void Check_BlackMethodCallLiteral_NoProblem()
    {
    ...
    [Test]
    [Category("BlackMethod")]
    public void Check_BlackMethodCallUnsafeSourceNoParameter_ReturnsProblem()
    {
    ...
    [Test]
    [Category("BlackMethod")]
    public void Check_BlackMethodCallSafeSource_NoProblem()
    {
    ...
    [Test]
    [Category("BlackMethod")]
    public void Check_BlackMethodCallUnsafeSourceWithSafeParameter_ReturnsProblem()
    {
    ...
    [Test]
    [Category("BlackMethod")]
    public void Check_WhiteMethodCall_NoProblem()
    {
