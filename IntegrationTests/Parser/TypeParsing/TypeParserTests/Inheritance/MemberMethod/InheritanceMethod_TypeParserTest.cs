...
namespace InjectionCop.IntegrationTests.Parser.TypeParsing.TypeParserTests.Inheritance.MemberMethod
{
  ...
  public class InheritanceMethod_TypeParserTest : TypeParserTestBase
  {
    ...
    public void Parse_SafeCallOnInheritedMethod_NoProblem ()
    {
      ...
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeCallOnInheritedMethod");
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "UnsafeCallOnInheritedMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeCallOnMethodInheritedFromSuperiorClass");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeCallOnNewMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "UnsafeCallOnNewMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "UnsafeStaticBindingOnNewMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeCallBaseMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "UnsafeCallBaseMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeCallOnOverriddenMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "AnotherSafeCallOnOverriddenMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "UnsafeCallOnOverriddenMethod");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
    ...
    {
      TypeNode sampleTypeNode = IntrospectionUtility.TypeNodeFactory<InheritanceSampleMethod>();
      Microsoft.FxCop.Sdk.Method sample = IntrospectionUtility.MethodFactory (sampleTypeNode, "SafeDynamicBinding");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
