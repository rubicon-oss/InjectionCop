...
{
  [TestFixture]
  public class LostAndFound_TypeParserTest: TypeParserTestBase
  {
    [Test]
    ...
    [Test]
    public void Parse_ComplexCondition_NoProblem ()
    {
      Method sample = TestHelper.GetSample<LostAndFoundSample> ("ComplexCondition");
      _typeParser.Parse (sample);
      ProblemCollection result = _typeParser.Problems;
